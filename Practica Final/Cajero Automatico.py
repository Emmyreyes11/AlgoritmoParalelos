...
if __name__ == "__main__":
    banco1= Banco("Banco SRS")
    
    cliente1 = Cliente("Sulenny", "Pueblo Nuevo", "112", banco1)
    cliente2 = Cliente("Harolyn", "Jarabacoa", "121", banco1)

    cliente1.cuenta = Cuenta("112", 2000, 1000, "Corriente")
    cliente2.cuenta = Cuenta("121", 4500, 2100, "Ahorro")
    cajero = Cajero("Cajer0", "2819")
